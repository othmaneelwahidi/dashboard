...
<head>
    ...
    <style>
        ...
        .submenu li {
            margin-top: 10px;
            /* Gap between each list item */
        }

        .submenu li:first-child {
            margin-top: 0;
            /* Remove the top margin for the first item */
        }
        ...
        .sidebar ul>li {
            margin-bottom: 50px;
            /* Increased gap for parent list items */
        }

        .sidebar ul>li:last-child {
            margin-bottom: 0;
            /* Removes gap after the last item */
        }
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li class="dropdown">
                ...
                <ul class="submenu">
                    <li><a href="{{ route('categories.index') }}">Liste Catégories</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="submenu">
                    ...
                    <li><a href="{{ route('stocks.create') }}">Formulaire stock</a></li>
                </ul>
            </li>
        </ul>
